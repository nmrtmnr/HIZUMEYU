  ...
  export default {
    head: {
      ...
      meta: [
        ...
        { hid: 'og:title', property: 'og:title', content: `サウナ｜温浴／ひづめゆ｜地域をつなぐ温浴施設` },
    ...
    data: () => ({
      id : ID,
      // meta: {
      //   title: 'サウナ｜温浴／' + process.env.SITE_NAME,
      //   type: 'article',
      //   url: process.env.SITE_URL + '/' + ID + '/',
      // },
      cnts: {
        sauna: {
          id: 'sauna',
